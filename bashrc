...
# =========== SET UP UNIXCONFIG ===============
export PATH=$HOME/.local/bin:$UNIXCONFIG/bin:$HOME_DIR_LOCAL/bin:$HOME_DIR/bin:/usr/local/bin:/usr/local/android-sdk/platform-tools:/usr/local/android-sdk/tools:$PATH
export EDITOR=vim
